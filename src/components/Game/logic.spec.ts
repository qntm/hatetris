    ...
    const runs = [
      ...
      },
      {
        ...
        aiRuns: [
          {
            name: 'knewjade loop',
            expectedScore: 95 + 10 * 7,
            replays: {
              /*
                Using HATETRIS Mild (or HATETRIS), this scores 95 points and generates a particular well:
              ...
              */
              raw: (
                ...
                /*
                  These additional keystrokes, using HATETRIS Mild only, get us to score 105 and THE SAME WELL.
                  They can be repeated indefinitely for infinite score!
                  (With HATETRIS, it detects the possible repeat well and spawns a different piece
                */
