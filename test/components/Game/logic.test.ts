    ...
    const runs = [
      ...
      },
      {
        ...
        aiRuns: [
          ...
          {
            name: 'David & Felipe loop 3',
            expectedScore: 7 + 10 * 4, // ranking = 17
            replays: {
              raw: (
                '' +
                ''.repeat(4)
              )
            }
          }
        ]
